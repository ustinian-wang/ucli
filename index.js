...
import {generateFile, img2base64url} from "./src/utils/file.js";
...
program
    ...
    .option('-t, --type <type>', 'Specify file ext(png,jpg,png,epub)', "png")  // 带有默认值的选项，使用解析函数
    ...
    .action(async(options)=>{
        ...
        outputPath+= "."+type;
        // 调用函数
        generateFile(parseInt(width), parseInt(height), type, outputPath);
})
